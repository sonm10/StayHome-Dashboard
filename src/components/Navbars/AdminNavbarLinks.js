...
export default function HeaderLinks(props) {
  ...
  const handleClickSelfieVerification = event =>{
    //
  ...
  return (
    <div className={wrapper}>
      ...
      >
        ...
        <Hidden mdUp implementation="css">
          <span className={classes.linkText}>
            {rtlActive ? "لوحة القيادة" : "Alert Cases"}
          </span>
        </Hidden>
      </Button>
      <Button
        href="/admin/selfieverification"
        color="transparent"
        simple
      ...
      >
        ...
        <Hidden mdUp implementation="css">
          <span className={classes.linkText}>
            {rtlActive ? "لوحة القيادة" : "Selfie Verification"}
          </span>
        </Hidden>
      </Button>
